...
\title[]%
    {Automatisatie van het onboardingproces binnen het gemeentebestuur van Berlare}
...
breaklines,
fontsize=\small
]{powershell}{../scripts/PowerAutomate.ps1}
...
breaklines,
fontsize=\small
]{powershell}{../scripts/Enddate.ps1}
