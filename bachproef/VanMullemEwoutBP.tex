...
\input{huidigeprocessen}
\input{analyseontwerp}
\input{powerautomate}
\input{evaluatie}
%\input{...}
%...
...
\inputminted{powershell}{../scripts/PowerAutomate.ps1}
...
\inputminted{powershell}{../scripts/Enddate.ps1}
...
\inputminted{powershell}{../scripts/DisableUser.ps1}
...
\inputminted{powershell}{../scripts/SharedMailbox.ps1}
